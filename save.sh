...
echo "git remote add origin https://github.com/GuidoRiosCiaffaroni/wp_edmin_crud.git"
git remote add origin https://github.com/GuidoRiosCiaffaroni/wp_edmin_crud.git
